...
abstract class AbstractPost extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \Rokanthemes\Blog\Model\Post
     */
    protected $_post;
     ...
     * @var string
     */
    protected $_defaultPostInfoBlock = 'Rokanthemes\Blog\Block\Post\Info';

    /**
     * @var string
     */
    //protected $_defaultPostCommentsBlock = 'Rokanthemes\Blog\Block\Post\View\Comments';
    ...
    public function __construct(
        ...
        \Rokanthemes\Blog\Model\Post $post,
        \Magento\Framework\Registry $coreRegistry,
        \Magento\Cms\Model\Template\FilterProvider $filterProvider,
        \Rokanthemes\Blog\Model\PostFactory $postFactory,
        array $data = []
    ) {
     ...
     *
     * @return \Rokanthemes\Blog\Model\Post
     */
     ...
     *
     * @return \Rokanthemes\Blog\Block\Post\Info
     */
