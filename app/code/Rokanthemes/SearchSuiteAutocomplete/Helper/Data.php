...
namespace Rokanthemes\SearchSuiteAutocomplete\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const XML_PATH_SEARCH_DELAY = 'rokanthemes_searchsuite/searchsuiteautocomplete_main/search_delay';

    /**
     * XML config path autocomplete fields
     */
    const XML_PATH_AUTOCOMPLETE_FIELDS = 'rokanthemes_searchsuite/searchsuiteautocomplete_main/autocomplete_fields';

    /**
     * XML config path suggest results number
     */
    const XML_PATH_SUGGESTED_RESULT_NUMBER = 'rokanthemes_searchsuite/searchsuiteautocomplete_main/suggested_result_number';

    /**
     * XML config path product results number
     */
    const XML_PATH_PRODUCT_RESULT_NUMBER = 'rokanthemes_searchsuite/searchsuiteautocomplete_main/product_result_number';

    /**
     * XML config path product result fields
     */
    const XML_PATH_PRODUCT_RESULT_FIELDS = 'rokanthemes_searchsuite/searchsuiteautocomplete_main/product_result_fields';
