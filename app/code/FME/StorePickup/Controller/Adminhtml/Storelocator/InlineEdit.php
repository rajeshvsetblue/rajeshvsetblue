...
use FME\StorePickup\Model\StorePickup as ModelStorelocator;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $Id) {
            ...
            try {
                ...
                $this->setStorePickupStorelocatorData($Storelocator, $extendedPageData, $Data);
    ...
    protected function validatePost(
        array $pageData,
        \FME\StorePickup\Model\StorePickup $page,
        &$error,
        array &$messages
    ) {
    ...
    public function setStorePickupStorelocatorData(
