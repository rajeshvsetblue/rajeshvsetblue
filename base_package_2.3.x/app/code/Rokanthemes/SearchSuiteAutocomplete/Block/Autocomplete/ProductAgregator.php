...
namespace Rokanthemes\SearchSuiteAutocomplete\Block\Autocomplete;

use \Rokanthemes\SearchSuiteAutocomplete\Block\Product as ProductBlock;
...
{
    /**
     * @var \Rokanthemes\SearchSuiteAutocomplete\Block\Product
     */
    ...
    public function getAddToCartData()
    {
        $formUrl             = $this->productBlock->getAddToCartUrl(
            $this->getProduct(),
            ['rokanthemes_searchsuiteautocomplete' => true]
        );
